...
import RentProperty from "../../../../components/pages/RentProperty";

export default function index() {
  return (
    <>
      <Head>
        <title>Warehouse Servicez - Add Property for Rent</title>
        <meta charSet="utf-8" />
        <link
          rel="icon"
        ...
        <meta
          name="description"
          content="Welcome to the property Services , where we build your visions."
        />
        <meta
          property="og:title"
          content="Warehouse Servicez - Add property for rent"
        />
        <meta
          name="keywords"
